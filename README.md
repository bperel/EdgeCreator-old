...
A graphical tool allowing to generate edge pictures.
EdgeCreator belongs to the [DucksManager](https://github.com/bperel/DucksManager) project
...
[Wiki](https://github.com/bperel/EdgeCreator/wiki)
